...
define( 'ALGQ_BUYER_PORTAL_VERSION', '1.2.0' );
...
require_once ALGQ_BUYER_PORTAL_DIR . 'includes/class-algq-buyer-marketplace-integration.php';
...
add_action(
    ...
    static function (): void {
        ...
        ALGQ_Buyer_Marketplace_Integration::init();
    }
);
