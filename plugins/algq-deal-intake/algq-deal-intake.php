 ...
 * Description: Production seller-lead and property-submission intake with consent evidence, duplicate review, lead scoring, protected submission artifacts, homeowner options, property review, and controlled Pipeline CRM handoff for Algonquian Real Estate LLC.
 * Version: 2.1.0
...
require_once ALGQ_DI_DIR . 'includes/class-production-feedback.php';
...
add_action(
	...
	static function (): void {
		...
		ALGQ_Deal_Intake_Production_Feedback::register_hooks();
	}
);
